...
class nitecaiform extends StatefulWidget {
  const nitecaiform({Key? key}) : super(key: key);

  @override
  State<nitecaiform> createState() => _nitecaiformState();
}

class _nitecaiformState extends State<nitecaiform> {

  Future sendData()async{
    final dataBase= FirebaseFirestore.instance.collection("খাবার নিতে চায়");
    return dataBase.doc().set({
      "নাম": _name.text,
      "প্রতিষ্টানের নাম": _protisthanerName.text,
      ...
      "কত জনের খাবার নিতে চায়": _humanNumber.text,
      "মতামত": _motamot.text,
    });
  }

  TextEditingController _name=new TextEditingController();
  TextEditingController _protisthanerName=new TextEditingController();
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
          ...
          //   height: 10,
          // ),
          Text('ক্ষুধা নিবারণ', style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold),),
          Padding(
                  ...
                  child: Form(
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 10,),
                          TextFormField(
                            controller: _protisthanerName,
                            keyboardType: TextInputType.text,
                            autocorrect: true,
                            decoration: InputDecoration(
                              hintText: 'আপনার প্রতিষ্ঠানের নাম(যদি থাকে)',
                          ...
                          TextFormField(
                            validator: (value) {
                              if (value == null || value.isEmpty) {
                                return 'কতজনের খাবার প্রয়োজন সেটি লিখুন';
                              }
                              return null;
                            },
