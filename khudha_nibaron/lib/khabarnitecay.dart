...
class khabarnitecayList extends StatefulWidget {

  @override
  State<khabarnitecayList> createState() => _khabarnitecayListState();
}

class _khabarnitecayListState extends State<khabarnitecayList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: FirebaseFirestore.instance.collection('খাবার নিতে চায়').snapshots(),
                          ...
                          children: [
                            SingleChildScrollView(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Text('প্রতিষ্টানের নাম : ', style: TextStyle(fontSize: 18),),
                                  Text(document['প্রতিষ্টানের নাম'], style: TextStyle(fontSize: 18),),
                                ],
                              ),
                            ),
                            SingleChildScrollView(
                            ...
                            SingleChildScrollView(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Text('কত জনের খাবার নিতে চায় : ', style: TextStyle(fontSize: 18),),
                                  Text(document['কত জনের খাবার নিতে চায়'], style: TextStyle(fontSize: 18),),
                                ],
                              ),
                            ),
                            SingleChildScrollView(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text(document['মতামত'], style: TextStyle(fontSize: 18),),
                                ],
                              ),
                            ),
                          ],
